...
import com.dennis.auth.service.JpaOAuth2AuthorizationService;
import java.time.Instant;
import java.util.*;

import com.dennis.auth.config.authentication.publicClientRefreshToken.PublicClientRefreshTokenAuthenticationConverter;
import com.dennis.auth.config.authentication.publicClientRefreshToken.PublicClientRefreshTokenAuthenticationProvider;
...
public class AuthorizationServerConfig {
	...
	public SecurityFilterChain authorizationServerSecurityFilterChain(
			...
			JpaOAuth2AuthorizationService authorizationService) throws Exception {
...
//				.clientId("angular-oidc2")
////				.clientSecret("{noop}secret1")
//				.clientAuthenticationMethod(ClientAuthenticationMethod.NONE)
//				.authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
//				.authorizationGrantType(AuthorizationGrantType.REFRESH_TOKEN)
//				.redirectUri("http://oidc-ui:4201/*")
//				.postLogoutRedirectUri("http://oidc-ui:4201/index.html")
//				.scope(OidcScopes.OPENID)
//				.scope("ui")
////				.scope("message.read")
////				.scope("message.write")
